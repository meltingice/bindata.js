...
var jspack = new JSPack(); ;
  ...
  */
  ...
  if (typeof exports !== "undefined" && exports !== null) fs = require('fs');
  ...
  Log = (function() {
    ...
    Log.output = function(method, data) {
      if (typeof exports !== "undefined" && exports !== null) {
        ...
        if (PSD.DEBUG) return console[method]("[BinData]", data);
      }
    };
  ...
  BinData.File = File = (function() {
    ...
    File.prototype.readShortInt = function() {
      return this.readf(">h")[0];
    };

    File.prototype.readShortUInt = function() {
      return this.readf(">H")[0];
    };

    File.prototype.readLongInt = function() {
      return this.readf(">l")[0];
    };

    File.prototype.readLongUInt = function() {
      return this.readf(">L")[0];
    };
    ...
    File.prototype.readLengthWithString = function(defaultLen) {
      var length, str;
    ...
    File.prototype.skipBlock = function(desc) {
      var n;
  ...
  BinData.DataType = DataType = (function() {
    ...
    DataType.prototype.readFormat = function(format, data) {
      var file;
      file = new File(data);
      return this.data = file.readf(format);
    };
  ...
  BinData.Type.Char = (function(_super) {
    ...
    function Char() {
      Char.__super__.constructor.apply(this, arguments);
    }
  ...
  BinData.Type.Long = (function(_super) {
    ...
    function Long() {
      Long.__super__.constructor.apply(this, arguments);
    }
  ...
  BinData.Type.LongLong = (function(_super) {
    ...
    function LongLong() {
      LongLong.__super__.constructor.apply(this, arguments);
    }
